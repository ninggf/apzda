...
JVM_GC_OPTS="-XX:+DisableExplicitGC -Xlog:gc:${WORKSPACE}/logs/gc.log"

## Adjust oom dump options if necessary
JVM_OOM_OPTS="-XX:+HeapDumpOnOutOfMemoryError -XX:-OmitStackTraceInFastThrow -XX:HeapDumpPath=${WORKSPACE}/dump/"
