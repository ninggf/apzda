...
function prepare_args {
    ...
    # Detect service name
    unset JVM_GC_OPTS JAVA_OPTS JVM_OOM_OPTS LOGBACK_CONFIG PROMETHEUS_AGENT APM_AGENT
    ...
    export JAVA_OPTS="$JAVA_OPTS -Djarun.hash=$SERVICE_HASH $JVM_GC_OPTS $JVM_OOM_OPTS $PROMETHEUS_AGENT $APM_AGENT"
